...
export function OpenAILogo(props: React.ImgHTMLAttributes<HTMLImageElement>) {
  return (
    <img 
      src="https://od.lk/s/OTNfMzY2MDI0ODVfVFFVQ3A/chatgpt-icon.png" 
      alt="OpenAI" 
...
export function AnthropicLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 512 509.64" {...props}>
...
export function GrokLogo(props: React.ImgHTMLAttributes<HTMLImageElement>) {
  return (
    <img 
      src="https://od.lk/s/OTNfMzY2MDI0ODRfQnl3Y2k/grok-icon.png" 
      alt="xAI Grok" 
      referrerPolicy="no-referrer"
      {...props} 
    />
